...
import { formatLocalIsoString } from '../src/lib/utils';
 ...
 * 実際のコード (src/lib/utils.ts) と同じ関数を使用することで、
 * 「テストで検証したロジック＝本番で動くロジック」であることを保証する。
 */
const formatLocal = formatLocalIsoString;
